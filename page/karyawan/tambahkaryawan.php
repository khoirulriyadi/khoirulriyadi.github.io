		...
		<div class="card-body">
			...
			<form method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" maxlength="30" class="form-control" name="username" id="username"
				...
				<div class="form-group">
					...
					<input type="number" min="0" maxlength="20" class="form-control" name="no_hp" id="no_hp"
						placeholder="No Handphone" required>
				</div>
				<div class="form-group">
					<label for="alamat">Alamat</label>
					<input type="text" maxlength="100" class="form-control" name="alamat" id="alamat"
						placeholder="Alamat" required>
				</div>
				<div class="form-group">
					<label for="Catatan">Catatan</label>
					<textarea type="text" maxlength="255" class="form-control" name="catatan" id="catatan"
